    ...
    <div class="p-6 flex space-x-2">
        ...
        <div class="flex-1">
          ...
          <img v-if="chirp.image" v-bind:src="'storage/chirps/images/'+ chirp.image "  class="img-responsive" />
            ...
            <font-awesome-icon  v-if="chirp.user.id !== $page.props.auth.user.id " @click="down()" icon="fa-solid fa-down-long" />
              {{ chirp.reactions_sum_down }} down | 
            <font-awesome-icon v-if="chirp.user.id !== $page.props.auth.user.id" @click="up()" icon="fa-solid fa-up-long" />
           {{ chirp.reactions_sum_up}} up
        </div>
    </div>
</template>